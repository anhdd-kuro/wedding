...
export const ui = {
  ...
  ja: {
    ...
    japanese: "和装",
    "story-1":
      "私たちは初めて出会ったのは、美術工業学校の狭い路地にある陶器屋でした。ハノイ市内のいろいろな路地を歩きながら、お互いを知り、そしていつの間にかカップルになりました。一緒に過ごした時間は、楽しいこともあり、悲しいこともあり、幸福な瞬間もありましたが、辛い瞬間も決して少なくありませんでした。私たちは文字通りと比喩的な意味で、嵐の日々を共にしました ☺️。",
    "story-2":
      "彼は、たくさんの夢を胸に日本に旅立ちました 🇯🇵。おそらく、私たち2人にとって忘れられない経験でしょう！2年以上の遠距離恋愛の時期は、私はベトナム 🇻🇳 、彼は日本 🇯🇵 で。",
    "story-3":
      "私たちは福岡で再会することができました。この困難な時期を一緒に乗り越えることができたことは本当に幸運でした。",
    "story-4":
      "再び別れる時がやってきました。彼は日本に残り、私はベトナムに帰国して自分のキャリアを追求しました。長い間続いた時期は、終わりが見えないようなものでした。しかし、ある日、彼が突然現れ、それからすべてが変わりました。",
    "story-5":
      "やっと、8年間の付き合いを経て、私たちの物語は全く新しい章に入りました。私たちは共に家庭を築く努力を続け、毎日一緒に過ごすことを願っています。",
    qr: "花嫁と花婿の幸福を祝福しましょう！",
    covid: "Covid-19 大流行 🦠",
    swipe: "スワイプして次を見る",
    backside: "裏面を見る",

    ...
    return (
      <strong className="flex-center mt-4 gap-x-[2rem] text-[4rem] font-medium tracking-wider text-black-light">
        <span className="flex-center flex-col">
          <span>{days}</span>
          <span className="text-[1.2rem] text-green">ngày</span>
        </span>
        <span className="flex-center flex-col">
          <span>{hours}</span>
          <span className="text-[1.2rem] text-green">giờ</span>
        </span>
        <span className="flex-center flex-col">
          <span>{minutes}</span>
          <span className="text-[1.2rem] text-green">phút</span>
        </span>
        <span className="flex-center flex-col">
          <span>{seconds}</span>
          <span className="text-[1.2rem] text-green">giây</span>
        </span>
      </strong>
    )
  }
